...
This file tells Github Copilot how to work in this repository.
Read `ARCHITECTURE.md` for full project context before starting any task.
...
- Scopes needed: see `ARCHITECTURE.md` Section 4.1
