...
def mock_llm_chain():
    ...
    import spotify_agent.utils as agent_utils
    
    # 1. Patch get_llm in the utils module 
    with patch("spotify_agent.utils.get_llm") as mock_get_llm:
        mock_llm = MagicMock()
        ...
        with patch("spotify_agent.utils.initialize_tools") as mock_init_tools:
            mock_tool = MagicMock()
